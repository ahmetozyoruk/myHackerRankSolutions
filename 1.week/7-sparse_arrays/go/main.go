...
func matchItem(strings []string, quiery string) int32 {
    var count int32
    count = 0 
...
func matchingStrings(strings []string, queries []string) []int32 {
    ...
    var mathedStringsCounts []int32
     
    for i := 0; i< len(queries); i++ {
        mathedStringsCounts = append(mathedStringsCounts,matchItem(strings,queries[i]))
    }
    
    return mathedStringsCounts
}
